...
STORAGE_VERSION = 1  # Kept at v1 so v0.1.x data can be migrated in-memory safely.
...
NATIVE_INTEGRATIONS = [
    {
        ...
        "name": "LG Infrared",
        "brand": "LG",
        "device_types": ["tv", "air_conditioner"],
        "semantic_entities": ["media_player", "climate"],
        "note": "TV và điều hòa LG; có hỗ trợ receiver cho một số trạng thái/lệnh.",
    },
    {
        "domain": "samsung_infrared",
        "name": "Samsung Infrared",
        "brand": "Samsung",
        "device_types": ["tv", "air_conditioner"],
        "semantic_entities": ["media_player", "climate"],
        "note": "TV và điều hòa Samsung dùng giao thức native của Home Assistant.",
    },
    {
        ...
        "brand": "Dyson",
        "device_types": ["fan"],
        "semantic_entities": ["fan"],
        "note": "Quạt/máy lọc không khí Dyson điều khiển IR.",
    },
    {
        "domain": "edifier_infrared",
        "name": "Edifier Infrared",
        "brand": "Edifier",
        "device_types": ["speaker", "soundbar"],
        "semantic_entities": ["media_player"],
        "note": "Loa Edifier có profile/model native.",
    },
    {
        "domain": "marantz_infrared",
        "name": "Marantz Infrared",
        "brand": "Marantz",
        "device_types": ["receiver", "amplifier"],
        "semantic_entities": ["media_player"],
        "note": "Ampli/receiver Marantz điều khiển bằng IR.",
    },
    {
        "domain": "led_infrared",
        "name": "LED Infrared",
        "brand": "Generic LED",
        "device_types": ["light"],
        "semantic_entities": ["light"],
        "note": "LED strip/bulb dùng remote IR 13/24/40/44 nút được hỗ trợ native.",
    },
    {
        ...
        "semantic_entities": ["media_player"],
        "note": "Loa Persang có mã native trong Home Assistant.",
    },
]
